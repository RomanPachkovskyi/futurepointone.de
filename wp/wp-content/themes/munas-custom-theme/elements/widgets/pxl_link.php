...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_link',
        'title' => esc_html__('Case Links', 'vintech'),
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'options' => [
                                ...
                                'style-gradient' => 'Style - Divider - Gradient',
                                'style-3' => 'Style 3',
                        ...
                        array(
                            ...
                            'label' => esc_html__('Color Divider', 'vintech' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Typography Hover', 'vintech' ),
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',
                        ...
                        array(
                            'name' => 'bottom_spacer',
                            'label' => esc_html__('Vertical Spacer', 'vintech' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'control_type' => 'responsive',
                            'size_units' => [ 'px' ],
                            'range' => [
                        ...
                        array(
                            'name' => 'left_spacer',
                            'label' => esc_html__('Horizontal Spacer Left', 'vintech' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'control_type' => 'responsive',
                            'size_units' => [ 'px' ],
                            'range' => [
                        ...
                        array(
                            'name' => 'right_spacer',
                            'label' => esc_html__('Horizontal Spacer Right', 'vintech' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'control_type' => 'responsive',
                            'size_units' => [ 'px' ],
                            'range' => [
                        ...
                        array(
                            'name' => 'align_items',
                            'label' => esc_html__('Align Items', 'vintech' ),
                            'type' => \Elementor\Controls_Manager::CHOOSE,
                            'control_type' => 'responsive',
                            'options' => [
                                'flex-start' => [
                                    'title' => esc_html__( 'Flex Start', 'vintech' ),
                                ...
                                'flex-end' => [
                                    'title' => esc_html__( 'Flex End', 'vintech' ),
    ...
    'controls' => array_merge(
        ...
        array(
            ...
            array(
                ...
                'label' => esc_html__('Box Border Radius', 'vintech' ),
