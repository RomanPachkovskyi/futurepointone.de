...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_image',
        'title' => esc_html__('Case Image', 'vintech' ),
        'icon' => 'eicon-image',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'image',
                            'label' => esc_html__('Choose Image', 'vintech' ),
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'image_width',
                            'label' => esc_html__('Image Width', 'vintech' ),
                            'type' => \Elementor\Controls_Manager::CHOOSE,
                            'options' => [
                                'auto' => [
                                    'title' => esc_html__( 'Auto', 'vintech' ),
                        ...
                        array(
                            'name' => 'img_effect',
                            'label' => esc_html__('Image Effect', 'vintech' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                '' => 'None',
                        ...
                        array(
                            ...
                            'label' => esc_html__('Parallax Scroll Type', 'vintech' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'y' => 'Effect Y',
                                'x' => 'Effect X',
                        ...
                        array(
                            ...
                            'label' => esc_html__('Parallax Value', 'vintech' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'condition' => [
                                'img_effect' => 'pxl-parallax-scroll',
                            ],
                        ...
                        array(
                            'name' => 'max_tilt',
                            'label' => esc_html__('Max Tilt', 'vintech' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'condition' => [
                        ...
                        array(
                            'name' => 'speed_tilt',
                            'label' => esc_html__('Speed Tilt', 'vintech' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'condition' => [
                                'img_effect' => 'pxl-image-tilt',
                            ],
                        ...
                        array(
                            ...
                            'label' => esc_html__('Perspective Tilt', 'vintech' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'condition' => [
                                'img_effect' => 'pxl-image-tilt',
                            ],
                        ...
                        array(
                            'name' => 'speed_effect',
                            'label' => esc_html__('Speed', 'vintech' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'control_type' => 'responsive',
                            'size_units' => [ 'px' ],
                            'range' => [
                        ...
                        array(
                            'name' => 'img_display',
                            'label' => esc_html__('Hide on Screen <= 1400px', 'vintech'),
                            'type' => \Elementor\Controls_Manager::SWITCHER,
                            'default' => false,
                        ),
                        array(
                            'name' => 'hide_parallax_sm',
                            'label' => esc_html__('Disable Parallax on Mobile <= 767px', 'vintech'),
                            'type' => \Elementor\Controls_Manager::SWITCHER,
                            'default' => false,
                            'condition' => [
                                'img_effect' => ['pxl-parallax-scroll'],
