...
if(class_exists('WPCF7')) {
    ...
    if ($cf7) {
        ...
        $contact_forms[esc_html__('No contact forms found', 'vintech')] = 0;
    }

    pxl_add_custom_widget(
        array(
            'name' => 'pxl_contact_form',
            'title' => esc_html__('Case Contact Form', 'vintech'),
                ...
                'sections' => array(
                    array(
                        ...
                        'controls' => array(
                            array(
                                'name' => 'form_id',
                                'label' => esc_html__('Select Form', 'vintech'),
                    ...
                    array(
                        ...
                        'label' => esc_html__('Input', 'vintech'),
                        ...
                        'controls' => array(
                            ...
                            array(
                                ...
                                'label' => esc_html__( 'Border Color Focus', 'vintech' ),
                                'type' => \Elementor\Controls_Manager::COLOR,
                                'default' => '',
                                'selectors' => [
                            ...
                            array(
                                'name' => 'input_height',
                                'label' => esc_html__('Input Height', 'vintech' ),
                            ...
                            array(
                                ...
                                'label' => esc_html__('Textarea Height', 'vintech' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px' ],
                                'range' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Padding Textarea', 'vintech' ),
                                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                                'size_units' => [ 'px' ],
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__( 'Textarea Border Type', 'vintech' ),
                                'type' => \Elementor\Controls_Manager::SELECT,
                                'options' => [
                                    '' => esc_html__( 'None', 'vintech' ),
                                    'solid' => esc_html__( 'Solid', 'vintech' ),
                            ...
                            array(
                                ...
                                'label' => esc_html__( 'Textarea Border Width', 'vintech' ),
                                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Textarea Typography', 'vintech' ),
                                'type' => \Elementor\Group_Control_Typography::get_type(),
                                'control_type' => 'group',
                            ...
                            array(
                                'name' => 'textarea_color',
                                'label' => esc_html__('Textarea Color', 'vintech' ),
                                'type' => \Elementor\Controls_Manager::COLOR,
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Spacer Bottom', 'vintech' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px' ],
                                'range' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Spacer Left', 'vintech' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px' ],
                                'range' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Spacer right', 'vintech' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px' ],
                                'range' => [
...
array(
    ...
    'label' => esc_html__('Input Hover', 'vintech'),
    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
    'controls' => array(
        array(
    ...
    'controls' => array_merge(
        array(
            ...
            array(
                ...
                'label' => esc_html__('Button Color Hover', 'vintech' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
            ...
            array(
                ...
                'label' => esc_html__('Button Background Color', 'vintech' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
            ...
            array(
                ...
                'label' => esc_html__('Button Background Color Hover', 'vintech' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        array(
            ...
            array(
                'name' => 'btn_spacer_top',
                'label' => esc_html__('Spacer Top', 'vintech' ),
                'type' => \Elementor\Controls_Manager::SLIDER,
                'control_type' => 'responsive',
                'size_units' => [ 'px' ],
                'range' => [
...
array(
    'name' => 'extra',
    'label' => esc_html__('Extra', 'vintech'),
    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
    'controls' => array(
        array(
        ...
        array(
            'name' => 'des_box_color',
            'label' => esc_html__('Description Box Color', 'vintech' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
        ...
        array(
            'name' => 'ntt_padding',
            'label' => esc_html__('Notice Margin', 'vintech' ),
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'size_units' => [ 'px' ],
            'selectors' => [
        ...
        array(
            ...
            'label' => esc_html__('Notification Color', 'vintech' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
        ...
        array(
            ...
            'label' => esc_html__('Label Spacer Bottom', 'vintech' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ 'px' ],
            'range' => [
