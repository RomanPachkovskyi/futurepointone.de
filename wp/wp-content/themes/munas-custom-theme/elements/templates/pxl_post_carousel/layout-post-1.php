...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-slider pxl-post-carousel pxl-post-carousel1 <?php echo pxl_print_html($settings['style_l11'])?>" <?php if($drap !== false): ?>data-cursor-drap="<?php echo esc_html('DRAG', 'vintech'); ?>"<?php endif; ?>>
                                    ...
                                    <?php if($show_button == 'true') : ?>
                                        <div class="pxl-post--button">
                                            <a class="btn--readmore" href="<?php echo esc_url(get_permalink( $post->ID )); ?>">
                                                <span class="button-arrow-hover"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                  <path d="M5.66868 0.980579V2.03717C5.66868 2.3025 5.88377 2.51759 6.1491 2.51759L16.0559 2.51742L0.640712 17.9326C0.453096 18.1202 0.453096 18.4244 0.640712 18.612L1.38799 19.3593C1.5756 19.5469 1.87979 19.5469 2.0674 19.3593L17.4826 3.94411L17.4826 13.8511C17.4826 14.1164 17.6977 14.3315 17.963 14.3315L19.0196 14.3315C19.2849 14.3315 19.5 14.1164 19.5 13.8511L19.5 0.98042C19.5 0.715088 19.2849 0.499996 19.0196 0.5L6.14909 0.500159C5.88376 0.500162 5.66868 0.715252 5.66868 0.980579Z" fill="#252525"/>
                                              </svg>
                                        ...
                                        <div class="pxl-item--author">
                                         ...
                                         <?php if($show_date == 'true'): ?>
                                            <span class="post-date">
                                                <?php echo esc_html__('Updated On','vintech') ?>
