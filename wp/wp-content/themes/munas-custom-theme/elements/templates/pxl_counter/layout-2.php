...
<div class="pxl-counter pxl-counter2 <?php echo esc_attr($settings['pxl_animate'].' '.$settings['style']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
    <div class="pxl-counter--inner">
        <div class="pxl-counter--holder ">
            ...
            <?php if ($settings['style'] == 'style2') {
                echo '<div class="pxl-counter--right">';
            } ?>
