...
<div class="pxl-counter pxl-counter5 <?php echo esc_attr($settings['pxl_animate'].' '.$settings['style']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
    <div class="pxl-counter--inner">
        <div class="pxl-counter--holder pxl-flex-center">
        ...
        <div class="pxl-counter--holder-hide pxl-flex-center">
